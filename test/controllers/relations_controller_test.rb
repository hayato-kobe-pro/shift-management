...
class RelationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post relations_url, params: { relation: { room_id: @relation.room_id, user_id: @relation.user_id } }
    end
  ...
  test "should update relation" do
    patch relation_url(@relation), params: { relation: { room_id: @relation.room_id, user_id: @relation.user_id } }
